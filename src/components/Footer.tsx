  ...
  return (
    <footer className="bg-white border-t-2 border-gray-100 py-12">
      ...
      <a
        ...
        className="fixed bottom-8 right-8 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all z-50 flex items-center justify-center"
